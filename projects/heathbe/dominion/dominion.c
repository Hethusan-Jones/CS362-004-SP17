...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  // TODO: Implement 5 cards (including smithy and adventurer) using called functions, rather than the switch statement
  if (card == adventurer) {
...
int playVillage(struct gameState *state, int handPos) {
  ...
  //+2 Actions
  // BUG ALERT: Only give 1 action, when should give 2
